        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-white/80 text-sm">Climatização</li>
              <li className="text-white/80 text-sm">Ar Condicionado</li>
              <li className="text-white/80 text-sm">Exaustão de Coifas em Cozinhas Industriais</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-white/80 text-sm">
                ...
                <a href="tel:+551135671300" className="hover:text-accent transition-colors">
                  (11) 3567-1300
                </a>
              </li>
              <li className="flex items-center gap-2 text-white/80 text-sm">
