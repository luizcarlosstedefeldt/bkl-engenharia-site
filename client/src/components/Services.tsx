  ...
  const services = [
    {
      ...
      description: 'Sistemas completos de ventilação industrial para processos e conforto térmico.',
    ...
    },
    {
      ...
      description: 'Soluções inovadoras de climatização com máxima eficiência energética.',
    ...
    },
    {
      ...
      description: 'Sistemas especializados de exaustão para cozinhas industriais e comerciais.',
