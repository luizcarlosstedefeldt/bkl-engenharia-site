  ...
  const services = [
    {
      ...
      description: 'Projetos de construção residencial, comercial e industrial com qualidade e segurança.',
      features: ['Estrutura de concreto', 'Acabamento premium', 'Gestão de obra'],
    },
    {
      id: 2,
      icon: Hammer,
      title: 'Reformas e Restauração',
      description: 'Reformas completas com design moderno e materiais de alta qualidade.',
      features: ['Projeto personalizado', 'Execução profissional', 'Prazos garantidos'],
    },
    {
      id: 3,
      icon: Wind,
      title: 'Sistemas de Ventilação',
      description: 'Instalação de sistemas de climatização e ventilação industrial.',
      features: ['Sistemas modernos', 'Eficiência energética', 'Manutenção técnica'],
    },
    {
      id: 4,
      icon: Zap,
      title: 'Engenharia Especializada',
      description: 'Consultoria e projetos de engenharia para soluções customizadas.',
      features: ['Análise técnica', 'Projetos BIM', 'Consultoria profissional'],
    },
  ];
